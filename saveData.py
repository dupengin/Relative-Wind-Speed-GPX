...
def saveDataCSV(ex_data, headWind, usrDir, usrSpeed, resWindSpeed, ResWindDir ):
    ...
    write_lists_to_csv(filename, headers, longitude, latitude, headWind, usrDir, usrSpeed, resWindSpeed, ResWindDir) #call the CSV writer, including the data sets to be written
